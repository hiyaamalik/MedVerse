...
function Navbar() {
  ...
  const styles = {
    ...
    navLinks: { display: "flex", listStyle: "none", gap: "25px" },
    link: { textDecoration: "none", color: "white", fontWeight: 500 },
  };
  ...
  return (
    <nav id="navbar" style={styles.navbar}>
      ...
      <ul style={styles.navLinks}>
        ...
        <li><a href="https://github.com" target="_blank" rel="noreferrer" style={styles.link}>GitHub</a></li>
